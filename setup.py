...
setup(
    name='''ckanext-custom-dataset-metadata''',
    ...
    description='''Add custom metadata to dataset schema in ckan''',
    long_description=long_description,
    long_description_content_type="text/markdown",

    # The project's main homepage.
    url='https://github.com//ckanext-custom-dataset-metadata',

    # Author details
    author='''Pooya Oladazimi, TIB''',
